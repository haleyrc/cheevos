...
func (repo *RosterRepository) GetInvitation(ctx context.Context, tx pg.Tx, i *cheevos.Invitation, id string) error {
...
func (repo *RosterRepository) GetInvitationByCode(ctx context.Context, tx pg.Tx, i *cheevos.Invitation, hashedCode string) error {
...
func (repo *RosterRepository) GetMembership(ctx context.Context, tx pg.Tx, m *cheevos.Membership, orgID, userID string) error {
...
func (repo *RosterRepository) InsertInvitation(ctx context.Context, tx pg.Tx, i *cheevos.Invitation, hashedCode string) error {
...
func (repo *RosterRepository) InsertMembership(ctx context.Context, tx pg.Tx, m *cheevos.Membership) error {
...
func (repo *RosterRepository) InsertOrganization(ctx context.Context, tx pg.Tx, o *cheevos.Organization) error {
...
func (repo *RosterRepository) UpdateInvitation(ctx context.Context, tx pg.Tx, i *cheevos.Invitation, hashedCode string) error {
