...
func (repo *RosterRepository) GetInvitation(ctx context.Context, tx db.Tx, i *service.Invitation, id string) error {
...
func (repo *RosterRepository) GetInvitationByCode(ctx context.Context, tx db.Tx, i *service.Invitation, hashedCode string) error {
...
func (repo *RosterRepository) GetMembership(ctx context.Context, tx db.Tx, m *service.Membership, orgID, userID string) error {
...
func (repo *RosterRepository) InsertInvitation(ctx context.Context, tx db.Tx, i *service.Invitation, hashedCode string) error {
...
func (repo *RosterRepository) InsertMembership(ctx context.Context, tx db.Tx, m *service.Membership) error {
...
func (repo *RosterRepository) InsertOrganization(ctx context.Context, tx db.Tx, o *service.Organization) error {
...
func (repo *RosterRepository) UpdateInvitation(ctx context.Context, tx db.Tx, i *service.Invitation, hashedCode string) error {
