...
func TestAcceptingAnInvitationFailsIfTheInvitationIsExpired(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			GetInvitationByCodeFn: func(_ context.Context, _ db.Tx, _ *cheevos.Invitation, _ string) error { return nil },
		}
...
func TestAcceptingAnInvitationSucceeds(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			InsertMembershipFn: func(_ context.Context, _ db.Tx, _ *cheevos.Membership) error { return nil },
			GetInvitationByCodeFn: func(_ context.Context, _ db.Tx, inv *cheevos.Invitation, _ string) error {
...
func TestInvitingAUserToAnOrganizationDoesNotSendAnEmailIfTheInvitationCantBeUpdated(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			InsertInvitationFn: func(_ context.Context, _ db.Tx, _ *cheevos.Invitation, _ string) error {
...
func TestInvitingAUserToAnOrganizationSucceeds(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			InsertInvitationFn: func(_ context.Context, _ db.Tx, _ *cheevos.Invitation, _ string) error { return nil },
		}
...
func TestRefreshingAnInvitationDoesNotSendAnEmailIfTheInvitationCantBeUpdated(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			GetInvitationFn: func(_ context.Context, _ db.Tx, _ *cheevos.Invitation, _ string) error { return nil },
			UpdateInvitationFn: func(_ context.Context, _ db.Tx, _ *cheevos.Invitation, _ string) error {
				return fmt.Errorf("oops")
			},
		}
...
func TestRefreshingAnInvitationSucceeds(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			GetInvitationFn: func(_ context.Context, _ db.Tx, inv *cheevos.Invitation, _ string) error {
				inv.Email = email
				inv.OrganizationID = orgID
				return nil
			},
			UpdateInvitationFn: func(_ context.Context, _ db.Tx, _ *cheevos.Invitation, _ string) error { return nil },
		}
...
func TestCreatingAValidOrganizationWithSucceeds(t *testing.T) {
	var (
		...
		repo = &mock.Repository{
			InsertMembershipFn:   func(_ context.Context, _ db.Tx, _ *cheevos.Membership) error { return nil },
			InsertOrganizationFn: func(_ context.Context, _ db.Tx, _ *cheevos.Organization) error { return nil },
		}
